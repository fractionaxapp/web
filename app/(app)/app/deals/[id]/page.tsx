...
export default async function DealDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main id="main" className="px-safe max-w-3xl py-12">
      ...
      {error && !deal && (
        <div className="mt-10">
          <h1 className="font-mono uppercase text-2xl font-semibold tracking-tight">Couldn’t load this deal</h1>
      ...
      {!deal && !error && (
        <div className="mt-10">
          ...
          <h1 className="mt-2 font-mono uppercase text-2xl font-semibold tracking-tight">Deal not found</h1>
      ...
      {deal && (
        <>
          <div className="mt-4 flex items-start justify-between gap-4">
            <h1 className="text-balance font-mono uppercase text-2xl font-semibold tracking-tight">{deal.title}</h1>
